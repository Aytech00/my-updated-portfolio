      ...
      <div className={styles.portfolio_inner_container}>
        ...
        >
          <div className={styles.inner_portfolio_wrap}>
            ...
            <p className={styles.portfolio_desc}> Built with ReactJS, Boostrap, SASS, MongoDB, ExpressJS.</p>
          </div>
          <div className={styles.inner_portfolio_wrap}>
            ...
            <p className={styles.portfolio_desc}>Built with ReactJS, Tailwindcss with a touch of CSS.</p>
          </div>
          <div className={styles.inner_portfolio_wrap}>
            ...
            <p className={styles.portfolio_desc}>Built with ReactJS, Bootsrap and CSS.</p>
          </div>
        </motion.div>
        ...
        >
          <div className={styles.inner_portfolio_wrap}>
            ...
            <p className={styles.portfolio_desc}>Built with Html, CSS, Bootsrap and Vanilla Javascript.</p>
          </div>
          <div className={styles.inner_portfolio_wrap}>
            ...
            <p className={styles.portfolio_desc}>A multichain Dapp built with SASS and Nextjs</p>
          </div>
          <div className={styles.inner_portfolio_wrap}>
            ...
            <p className={styles.portfolio_desc}> Built with HTML, SASS and Vanilla JS.</p>
          </div>
        </motion.div>
        ...
        >
          <div className={styles.inner_portfolio_wrap}>
            ...
            <p className={styles.portfolio_desc}>Built with ReactJS, Tailwindcss, Firebase realtime database.</p>
          </div>
